...
## 1. Stratégies de trading technique

Voici les stratégies que vous pouvez utiliser et qui sont intégrées dans la plateforme mais vous pouvez facilement de développer d'autres stratégies d'analyse technique que vous pourrez intégrer dans le menu des stratégies d'analyse.
...
### 1.1. Présentation de la Stratégie Ichimoku Kinko Hyo
...
Un fois ces éléments renseignés, vous cliquez sur le bouton **Graphique** pour afficher l'analyse technique de l'action (Stock).
...
En mode screen, vous pouvez parcourir toutes vos actions avec, par exemple, la stratégie des <a href="/2024/11/formation-indicateur-fractales-bill-williams.html" target="_blank">Fractales de Bill Williams</a>, pour découvrir les signaux d'achat ou de vente de cette stratégie automatique de trading :
...
Le portfolio ou gestionnaire de portefeuille est l'outil indispensable du trader efficace. Il vous permet de centraliser tous vos achats/ventes et de les consolider dans un tableau de bord afin de connaitre le rendement réel de vos trades sur les Cryptos, Actions, <a href="/2024/01/termes-boursiers.html#ETF">ETF</a>, <a href="/2024/01/termes-boursiers.html#Futures">Futures</a>, <a href="/2024/01/termes-boursiers.html#FOREX">Forex</a>, etc.
