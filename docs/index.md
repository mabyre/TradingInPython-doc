...
Découvrez la puissance de notre plateforme de trading technique et de ses stratégies automatisées en Python. {{ "TradingInPython" | keyword }} intègre toutes les stratégies d'analyse technique, nécessaires et suffisantes pour effectuer votre trading au quotidien et sécuriser vos investissements.

- Téléchargez le logiciel de la plateforme - [Téléchargement v1.7.0](https://github.com/SoDevLog/PyTrading/releases/download/v1.7.0/tradinginpython_setup.zip)
...
En vous abonnant {{ "vous bénéficiez des mises à jour du logiciel" | keyword }}. Vous pouvez vous former facilement avec les articles et les formations du blog. Vous avez des exemples d'utilisation des stratégies de trading en situation réelle et tout un tas d'analyses techniques gratuites.

## Licence gratuite

Les stratégies {{ "Ichimoku + deep learning" | keyword }} et {{ "Moyennes mobiles" | keyword }} sont gratuites, pour débloquer toutes les stratégies et toutes les fonctionnalités de la plateforme, afin de les essayer sans contraintes :

📧 [Demande de licence gratuite](mailto:plateforme@sodevlog.com?subject=Ma%20licence%20TradingInPython&body=Merci%20de%20m%27envoyer%20ma%20%20licence%20d%27utilisation)
