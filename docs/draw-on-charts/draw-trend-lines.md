...
Pour effacer une ligne ou une annotation : {{ "clique droit" | keyword }} aux environs de la ligne ou de l'annotation.

Vous souhaitez tout effacer : {{ "double clique droit" | keyword }}

Si vous n'avez pas l'habitude, c'est une manipulation délicate, si ce que vous faites ne fonctionne pas recommencer doucement.
