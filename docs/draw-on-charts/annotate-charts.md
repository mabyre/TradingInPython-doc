...
- **(1)** La croix vous permet de mettre en évidence les résistance et les supports du cours de l'action.

- **(2)** La barre verticale se poursuit dans les graphes secondaires.

En utilisant la {{ "touche 'V'" | keyword }} comme dans [Annoter les prix/dates](./annote-price-date.md) vous pouvez marquer les résistances et les supports du cours de l'action.
...
- **(1)** Les deux case ANNOTE et CROSS sont cochées.
- **(2)** La croix prix/date s'affiche sur le graphe.
- **(3)** L'annotation OHLC s'affiche sur la bougie.
